/*
 * font5x7.c
 * 5x7 classic bitmap font, 256 glyphs indexed by char code (font[c*5]).
 * Extracted verbatim from the Adafruit_GFX glcdfont.c (classic fixed font).
 */
#include "font5x7.h"

const uint8_t font5x7[FONT5X7_CHARS * FONT5X7_BYTES] = {
